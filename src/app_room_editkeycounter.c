...
static bool app_room_editkeycounter_tick(bui_room_ctx_t *ctx, bui_room_t *room, uint32_t elapsed);
static void app_room_editkeycounter_button(bui_room_ctx_t *ctx, bui_room_t *room, bool left, bool right);
static void app_room_editkeycounter_draw(bui_room_ctx_t *ctx, const bui_room_t *room, bui_bitmap_128x32_t *buffer);
...
static bool app_room_editkeycounter_tick(bui_room_ctx_t *ctx, bui_room_t *room, uint32_t elapsed) {
	return bui_bkb_animate(&APP_ROOM_EDITKEYCOUNTER_ACTIVE.bkb, elapsed);
}
...
static void app_room_editkeycounter_draw(bui_room_ctx_t *ctx, const bui_room_t *room, bui_bitmap_128x32_t *buffer) {
	bui_bkb_draw(&APP_ROOM_EDITKEYCOUNTER_ACTIVE.bkb, buffer);
}
