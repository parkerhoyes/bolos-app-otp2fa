...
const bui_room_t app_rooms_editkeyname = {
	.enter = app_room_editkeyname_enter,
	.exit = app_room_editkeyname_exit,
	.tick = app_room_editkeyname_tick,
	.button = app_room_editkeyname_button,
	.draw = app_room_editkeyname_draw,
};
...
static void app_room_editkeyname_enter(bui_room_ctx_t *ctx, bui_room_t *room, bool up) {
	bui_room_alloc(ctx, sizeof(app_room_editkeyname_active_t));
